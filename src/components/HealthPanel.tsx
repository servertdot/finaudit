...
const METRIC_HINTS: Record<string, ReactNode> = {
  savings: (
    <>
      <p>Какая доля дохода остаётся после всех расходов за месяц. Это прокси сбережений: приложение не видит, были ли деньги фактически отложены.</p>
      <p>
        <Formula>(Доходы − Расходы) / Доходы × 100%</Formula>
      </p>
      <p>Ориентир: ≥ 20% — хорошо, 10–20% — зона внимания, &lt; 10% — мало.</p>
    </>
  ),
  runway: (
    <>
      <p>
        На сколько месяцев хватит ликвидных активов, если доход пропадёт,
        при текущих необходимых расходах.
      </p>
      <p>
        <Formula>Ликвидные активы / Необходимые расходы</Formula>
      </p>
      <p>
        Необходимые расходы отмечаются в таблице отдельно. Ориентир: 6+ мес. —
        хорошо, 3–6 — зона внимания, &lt; 3 — мало.
      </p>
    </>
  ),
  'expense-ratio': (
    <>
      ...
      <p>Ориентир: ≤ 70% — хорошо, 70–90% — зона внимания, &gt; 90% — много.</p>
    </>
  ),
}
        ...
        <div className="flex flex-col gap-1">
          <span className="flex items-center gap-1.5 text-[12px] font-medium text-muted">
            ...
            <InfoHint title="Общая оценка" align="left">
              <p>
                Плавная средняя оценка доступных метрик: 0 — критично, 100 — все
                показатели на целевом уровне или лучше. Нейтральные метрики не учитываются.
              </p>
            </InfoHint>
          </span>
      ...
      <div className="mt-5 border-t border-line pt-5">
        <div className="mb-3 flex items-baseline justify-between gap-2">
          <h3 className="flex items-center gap-1.5 text-[13px] font-semibold text-ink">
            Структура 50/30/20
            <InfoHint title="Структура 50/30/20" align="left">
              <p>
                Ориентир распределения дохода: до 50% — на необходимые расходы,
                до 30% — на желания, от 20% — в остаток и сбережения.
              </p>
              <p>
